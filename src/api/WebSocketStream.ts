...
export class WebSocketStream<T extends ArrayBuffer | string = ArrayBuffer | string> {
  ...
  readonly opened: R.ResultAsync<WebSocketConnection<T>, WebSocketError>;

  readonly closed: R.ResultAsync<WebSocketCloseInfo, WebSocketError>;
          ...
          const errorHandler = (e: Event) => {
            ...
            reject(
              ConnectionError.websocket(
                'Encountered websocket error while establishing connection',
              ),
            );
